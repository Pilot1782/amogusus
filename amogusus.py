...
if __name__ == '__main__':
    ...
    for i in range(1, 51):
        make_shortcut('https://store.steampowered.com/app/945360/Among_Us/', name='Amogus_' + str(i), icon='amogus.ico', desktop=True)
    print('Shortcuts created!!111')

    change_bg(os.path.abspath('wallpaper.jpg'))
    print('Wallpaper changed!1!11')

    change_cur(os.path.abspath(r'cursor.cur'))
    ctypes.windll.user32.SystemParametersInfoA(0x57)
    print('Cursor changed!!1!1111')

    sound_path = os.path.abspath('AMOGUS.mp3')
